  ...
  <body id="page-top">
							...
							<div class="card mb-3 border-primary">
					            <div class="card-header">
					              ...
					              <?php echo $menuRow["menuName"]; ?>
									...
									<button class="btn btn-secondary btn-sm float-right" data-toggle="modal" data-target="#editMenuModal" data-category="<?php echo $menuRow["menuName"];?>" data-menuid="<?php echo $menuRow["menuID"];?>">Editar</button>
	...
	<div class="modal fade" id="editMenuModal" tabindex="-1" role="dialog" aria-labelledby="editMenuModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="editMenuModalLabel">Eitar Categoría</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
	      <div class="modal-body">
	        <form id="editmenuform" action="editmenu.php" method="POST">
	        	<div class="form-group">
		            <label class="col-form-label">Categoría:</label>
		            <input type="text" required="required" class="form-control" name="menuname" id="menuname" placeholder="Puedes poner algo como postres, bebidas, etc...." >
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" form="editmenuform" class="btn btn-success" name="editmenu">Editar</button>
	      </div>
	    </div>
	  </div>
	</div>
	      ...
	      <div class="modal-body">
	        <form id="additemform" method="POST">
	        	<div class="form-group">
		            ...
		            <input type="text" required="required" class="form-control" name="itemName" placeholder="Puedes poner algo como pique, Pepsi o algo así" >
		        </div>
		        <div class="form-group">
		            <label class="col-form-label">Precio (BOB):</label>
	...
	<div class="modal fade" id="editItemModal" tabindex="-1" role="dialog" aria-labelledby="editItemModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="editItemModalLabel">Editar Menú</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
	      <div class="modal-body">
	        <form id="edititemform" action="edititem.php" method="POST">
	        	<div class="form-group">
		            <label class="col-form-label">Nombre:</label>
		            <input type="text" required="required" id="itemname" class="form-control" name="itemName" placeholder="pique,Pepsi,etc" >
		        </div>	
		        <div class="form-group">
		            <label class="col-form-label">Precio (BOB):</label>
    ...
    <script>
		...
		$('#editMenuModal').on('show.bs.modal', function (event) {
			  ...
			  var modal = $(this);
			  modal.find('.modal-body #menuid').val(menuid);
			  modal.find('.modal-body #menuname').val(category);
		});
