...
<body id="page-top">
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="card mb-3">
                  ...
                  if ($result = $sqlconnection->query($displayStaffQuery)) {
                    ...
                    while ($staff = $result->fetch_array(MYSQLI_ASSOC)) {
                      ...
                      <tr class="text-center">
                        ...
                        <td class="text-center"><a href="#deleteStaff" data-toggle="modal" data-staffid=<?php echo $staff["staffID"]; ?> class="btn btn-sm btn-danger">Eliminar</a></td>
                      </tr>
              ...
              <div class="card-footer small text-muted"><i>Contraseña predeterminada para nuevo usuario : 1234abcd..</i>
              </div>
            </div>
          </div>
              ...
              <div class="card-body">
                <form action="addstaff.php" method="POST"
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" required="required" name="staffname" class="form-control"
                      placeholder="Nuevo Empleado" aria-label="Add" aria-describedby="basic-addon2">
  ...
  <!-- Eliminar staff-->
  <div class="modal fade" id="deleteStaff" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="deleteModalLabel">¿Estás seguro de eliminar este empleado?</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body">Seleccione "Eliminar" a continuación se eliminará a este empleado.</div>
        <div class="modal-footer">
  ...
  <script>
    $('#deleteStaff').on('show.bs.modal', function (event) {
      ...
      var staffid = button.data('staffid'); // Extract info from data-* attributes

      // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
      var modal = $(this);
      modal.find('.modal-body').html('Seleccione "Eliminar" a continuación se eliminará a este empleado.');
      modal.find('.modal-footer #staffid').val(staffid);
    });

    // Obtén el valor de data-staffid utilizando jQuery
